...
class AppearanceSettingsForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["orientation"] = forms.ChoiceField(
            label="Orientacja ekranu",
            choices=self.ORIENTATION_CHOICES,
    ...
    def to_palette(self):
        ...
        palette["orientation"] = self.cleaned_data.get("orientation") or palette["orientation"]
        return palette
